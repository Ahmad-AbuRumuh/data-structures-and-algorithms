...
const typeNum = (arr) => {
  let array = arr.filter(val => !isNaN(val));
  return array;
};
...
const containsAnd = (arr) => {
  let array = arr.filter(val => val.includes('and'));
  return array;
};
...
const oddValues = (arr) => {
  let array = arr.filter(val => val%2 !== 0);
  return array;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let array = arr.filter(val => !forbiddenValues.includes(val));
  return array;
};
