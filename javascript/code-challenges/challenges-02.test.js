...
const forEachTwoToThe = (arr) => {
  let array = [];
  arr.forEach(val => array.push(Math.pow(2, val)));
  return array;
};
...
const mapTwoToThe = (arr) => {
  let array = arr.map(val => Math.pow(2, val));
  return array;
};
